...
import com.github.ahrooranr.object_measurer.ObjectExplorer;
...
public class MemoryMeasurer {
     ...
     * is static in nature.
     */
    protected static final long costOfBareEnumConstant = instrumentation.getObjectSize(DummyEnum.CONSTANT);
